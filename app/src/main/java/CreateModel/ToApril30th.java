...
public class ToApril30th {
    public static List<WholeDayModel> toApril30th() {
        ...
        SingleModel singleModel0326_01 = new SingleModel("2016-3-26 18:34", false, "通过姑娘微信的好友验证请求，正式开始聊天。", new int[]{R.mipmap.pic01});
        singleModelList0326.add(singleModel0326_01);

        WholeDayModel wholeDayModel0326 = new WholeDayModel("2016-3-26", singleModelList0326, false, "", "", 0);
        list.add(wholeDayModel0326);

        //2016.03.27
        List<SingleModel> singleModelList0327 = new ArrayList<>();

        WholeDayModel wholeDayModel0327 = new WholeDayModel("2016-3-27", singleModelList0327, true, "2016-3-27 23:39", "D：安咯\n" +
                "\t\t L：…\n", R.mipmap.pic02);
        ...
        WholeDayModel wholeDayModel0328 = new WholeDayModel("2016-3-28", singleModelList0328, true, "2016-3-28 22:11", "D：安咯\n" +
                "\t\t L：…\n", R.mipmap.pic03);
        ...
        WholeDayModel wholeDayModel0329 = new WholeDayModel("2016-3-29", singleModelList0329, false, "", "", 0);
        list.add(wholeDayModel0329);

        //2016.03.30
        List<SingleModel> singleModelList0330 = new ArrayList<>();

        WholeDayModel wholeDayModel0330 = new WholeDayModel("2016-3-30", singleModelList0330, true, "2016-3-30 22:46", "D：安咯\n" +
                "\t\t L：…\n", R.mipmap.pic04);
        ...
        WholeDayModel wholeDayModel0331 = new WholeDayModel("2016-3-31", singleModelList0331, false, "", "", 0);
        list.add(wholeDayModel0331);

        //2016.04.01
        List<SingleModel> singleModelList0401 = new ArrayList<>();

        SingleModel singleModel0401_01 = new SingleModel("2016-4-1 08:21", false, "发给姑娘的安慰红包过期退还到钱包(哈，第一次发红包被拒收)。", new int[]{R.mipmap.pic05});
        singleModelList0401.add(singleModel0401_01);

        SingleModel singleModel0401_02 = new SingleModel("2016-4-1 09:34", false, "红包被拒，答应下次发两顿饭的红包给姑娘。", new int[]{R.mipmap.pic06});
        singleModelList0401.add(singleModel0401_02);

        WholeDayModel wholeDayModel0401 = new WholeDayModel("2016-4-1", singleModelList0401, true, "2016-4-1 23:23", "D：安咯\n" +
                " \t\t L：~\n" +
                " \t\t   汪~  (这一声 “汪” 是真的好听~这一刻猜到姑娘生肖)\n", R.mipmap.pic07);
        list.add(wholeDayModel0401);

        //2016.04.02
        List<SingleModel> singleModelList0402 = new ArrayList<>();

        SingleModel singleModel0402_01 = new SingleModel("2016-4-2 22:13", false, "姑娘说，下次弹出来了要给她听，我的天，好难的啊，表示此时此刻还没开始准备呢。。。(键盘钢琴 the truth that you leave)", new int[]{R.mipmap.pic08});
        singleModelList0402.add(singleModel0402_01);

        SingleModel singleModel0402_02 = new SingleModel("2016-4-2 22:30", false, "缘分，通过微信认识~", new int[]{R.mipmap.pic09});
        singleModelList0402.add(singleModel0402_02);

        SingleModel singleModel0402_03 = new SingleModel("2016-4-2 22:40", false, "姑娘暴露位置啦，距离苏宁73公里。真的不是我聪明，实在是你太早太早就把自己的位置暴露出来了。", new int[]{R.mipmap.pic10});
        singleModelList0402.add(singleModel0402_03);

        SingleModel singleModel0402_04 = new SingleModel("2016-4-2 22:46", false, "第一次提醒姑娘坐大巴要系安全带。", new int[]{R.mipmap.pic19});
        singleModelList0402.add(singleModel0402_04);

        WholeDayModel wholeDayModel0402 = new WholeDayModel("2016-4-2", singleModelList0402, false, "", "", 0);
        list.add(wholeDayModel0402);

        //2016.04.03
        List<SingleModel> singleModelList0403 = new ArrayList<>();

        WholeDayModel wholeDayModel0403 = new WholeDayModel("2016-4-3", singleModelList0403, false, "", "", 0);
        list.add(wholeDayModel0403);

        //2016.04.04
        List<SingleModel> singleModelList0404 = new ArrayList<>();

        SingleModel singleModel0404_01 = new SingleModel("2016-4-4 16:41", false, "不带姑娘飞(有自知之明，怕飞不动~)，姑娘说带她吃饭。", new int[]{R.mipmap.pic11});
        singleModelList0404.add(singleModel0404_01);

        SingleModel singleModel0404_02 = new SingleModel("2016-4-4 16:45", false, "无意间暴露了我已经知道了姑娘的名字，然而姑娘，哈，却浑然不知。", new int[]{R.mipmap.pic12});
        singleModelList0404.add(singleModel0404_02);

        SingleModel singleModel0404_03 = new SingleModel("2016-4-4 16:55", false, "第一次在姑娘面前透露我有抽过烟，虽然是无奈，但是她还是禁止抽烟。(原本换新公司之后我是有打算不抽的，但是或许没有这一刻这么坚定。如果没有姑娘的话，或许后面会抽，但是，这个世界是没有如果的呀，事实是我没抽！当然以后更加不会抽了！！！)", new int[]{R.mipmap.pic13});
        singleModelList0404.add(singleModel0404_03);

        SingleModel singleModel0404_04 = new SingleModel("2016-4-4 17:00", false, "姑娘说她是不喝酒的，无论怎么地都不会喝酒。啊，当时听到这个就觉得很好，是真的很好！我真是不希望将来女朋友会喝酒，尤其在外面，真的会担心。。。 有图为证，敢出去喝酒，乱棒打死！！！", new int[]{R.mipmap.pic14});
        singleModelList0404.add(singleModel0404_04);

        SingleModel singleModel0404_05 = new SingleModel("2016-4-4 22:55", false, "道出猜出姑娘属狗的原因，其实，真的只是个意外呢。", new int[]{R.mipmap.pic15});
        singleModelList0404.add(singleModel0404_05);

        WholeDayModel wholeDayModel0404 = new WholeDayModel("2016-4-4", singleModelList0404, true, "2016-4-4 22:56", "D：安咯\n" +
                "\t\t L：…", R.mipmap.pic15);
        ...
        SingleModel singleModel0405_01 = new SingleModel("2016-4-5 19:00", false, "跟姑娘提起了金雅然，在之后的聊天中，姑娘竟然提起来了，说实话，当姑娘提起来的时候，我都忘了什么时候跟她提过，原来，是吃醋了，哈哈", new int[]{R.mipmap.pic16});
        singleModelList0405.add(singleModel0405_01);

        SingleModel singleModel0405_02 = new SingleModel("2016-4-5 22:46", false, "跟姑娘聊了一下以后的事情，姑娘对以后家庭的态度和我真是相似了，想法很相近。", new int[]{R.mipmap.pic17});
        singleModelList0405.add(singleModel0405_02);

        WholeDayModel wholeDayModel0405 = new WholeDayModel("2016-4-5", singleModelList0405, true, "2016-4-5 22:50", "D：晚安\n" +
                "\t\t L：[晚安表情]", R.mipmap.pic18);
        list.add(wholeDayModel0405);

        //2016.04.06
        List<SingleModel> singleModelList0406 = new ArrayList<>();

        SingleModel singleModel0406_01 = new SingleModel("2016-4-6 23:31", false, "挺晚的一天，陪老总在外包公司待到凌晨，然后才能回去，然而姑娘也是备课到很晚。", new int[]{R.mipmap.pic20});
        singleModelList0406.add(singleModel0406_01);

        WholeDayModel wholeDayModel0406 = new WholeDayModel("2016-4-6", singleModelList0406, true, "2016-4-6 23:35", "D：晚安！\n" +
                "\t\t L：…", R.mipmap.pic21);
        ...
        SingleModel singleModel0407_01 = new SingleModel("2016-4-7 09:00", true, "第一次答应给姑娘弄点干粮过去，然而姑娘一开口就是要肉，甚至发挥了生肖特性~", new int[]{R.mipmap.pic22});
        singleModelList0407.add(singleModel0407_01);

        SingleModel singleModel0407_02 = new SingleModel("2016-4-7 18:23", false, "问姑娘能不能吃辣，是想给她买点煌上煌的烤鸭过去，哈，结果那货以为，我要给她买辣条，什么品味？!", new int[]{R.mipmap.pic23});
        singleModelList0407.add(singleModel0407_02);

        SingleModel singleModel0407_03 = new SingleModel("2016-4-7 20:02", false, "姑娘在朋友圈发了两张她高中班上的照片，说什么照片中有她，哈，我都没有见过她呢，虽然在后面配了张自拍，但是那个时候真的不知道是她，所以那张自拍直接被我给忽略，没有进行任何参考，纯粹靠自己的推理把人给猜出来，机智如我~！！", new int[]{R.mipmap.pic24});
        singleModelList0407.add(singleModel0407_03);

        SingleModel singleModel0407_04 = new SingleModel("2016-4-7 20:52", false, "猜中照片的姑娘，所以有奖励，但是，不知道是什么呢。。。？", new int[]{R.mipmap.pic25});
        singleModelList0407.add(singleModel0407_04);

        WholeDayModel wholeDayModel0407 = new WholeDayModel("2016-4-7", singleModelList0407, true, "2016-4-7 21:53", "D：晚安\n" +
                "\t\t L：…", R.mipmap.pic26);
        ...
        SingleModel singleModel0408_01 = new SingleModel("2016-4-8 19:18", false, "真的是打算给姑娘买点吃的寄过去的，所以要地址和号码，然而姑娘拒绝了。。。怎么说呢，被拒绝，觉得挺好的，因为这姑娘不会吃的就出卖了自己。其次，有点失落呢，因为从这个时候开始，是真的想为姑娘做点什么了。。。。。。", new int[]{R.mipmap.pic27});
        singleModelList0408.add(singleModel0408_01);

        SingleModel singleModel0408_02 = new SingleModel("2016-4-8 20:59", true, "答应等发了工资，要请姑娘吃东西。", new int[]{R.mipmap.pic28});
        singleModelList0408.add(singleModel0408_02);

        WholeDayModel wholeDayModel0408 = new WholeDayModel("2016-4-8", singleModelList0408, true, "2016-4-8 23:06", "D：晚安\n" +
                "\t\t L：…   (哈，好心跟姑娘说晚安，竟然说我打断了她的音乐，还直接关机，欠扁节奏)", R.mipmap.pic29);
        list.add(wholeDayModel0408);

        //2016.04.09
        List<SingleModel> singleModelList0409 = new ArrayList<>();

        WholeDayModel wholeDayModel0409 = new WholeDayModel("2016-4-9", singleModelList0409, true, "2016-4-9 22:44", "L：晚安~\n" +
                "\t\t D：哇，first blood。晚安\n" +
                "\t(这是姑娘第一次跟我说晚安呢，当时真的很激动呀，在此之前，我都跟她说了很多次了，然后她都是没说。。。一血，激动呢！！！)", R.mipmap.pic30);
        list.add(wholeDayModel0409);

        //2016.04.10
        List<SingleModel> singleModelList0410 = new ArrayList<>();

        SingleModel singleModel0410_01 = new SingleModel("2016-4-10 10:38", false, "姑娘第一次主动把她的事跟我说呢，之前的每一次，都是我主动去想点什么跟她说的，也许从这里开始，就慢慢开始不再有话题了吧。", new int[]{R.mipmap.pic31});
        singleModelList0410.add(singleModel0410_01);

        SingleModel singleModel0410_02 = new SingleModel("2016-4-10 11:15", false, "姑娘竟然 主动 发了一张自拍过来，虽然没有露脸，这货。。。但是，已经算是很大进步了不是？跟我说头发枯黄，丫的，自己懒还好意思说了呢。。。好在那个时候还没有打算掌控姑娘的头发，否则，要骂人~！也就是这个时候吧，决定要给姑娘买护发素，头发太重要！！！", new int[]{R.mipmap.pic32});
        singleModelList0410.add(singleModel0410_02);

        WholeDayModel wholeDayModel0410 = new WholeDayModel("2016-4-10", singleModelList0410, true, "2016-4-10 22:13", "D：晚安\n" +
                "\t\t L：晚安~ (成常态了吗，嗯哼)", R.mipmap.pic33);
        list.add(wholeDayModel0410);

        //2016.04.11
        List<SingleModel> singleModelList0411 = new ArrayList<>();

        SingleModel singleModel0411_01 = new SingleModel("2016-4-11 22:09", false, "跟姑娘说，人一生会遇到2920万人，两个人相爱的概率是0.000049，这个是小概率事件，也就是不可能事件。不知道为什么想跟姑娘提起这个，也许从这个时候开始，姑娘，就慢慢成为姑娘了吧。", new int[]{R.mipmap.pic34});
        singleModelList0411.add(singleModel0411_01);

        SingleModel singleModel0411_02 = new SingleModel("2016-4-11 22:42", false, "姑娘这天晚上的心情很不好。。。一个人在桌子上面趴了三个小时，甚至差点流泪，那一刻吧，真的开始心疼了，一个傻乎乎的姑娘，才刚刚走出校园进入职场，新人，被批评，唉。。。很难过！感谢姑娘的信任，可以把心里面的不舒服告诉我，可以把不痛快跟我说，很难得，我知道！也是在这个时候，我告诉姑娘，一定不可以流泪，不管是因为什么事情，都不可以流泪！！！", new int[]{R.mipmap.pic35});
        singleModelList0411.add(singleModel0411_02);

        WholeDayModel wholeDayModel0411 = new WholeDayModel("2016-4-11", singleModelList0411, true, "2016-4-11 23:18", "D：晚安\n" +
                "\t\t L：晚安~", R.mipmap.pic36);
        ...
        SingleModel singleModel0412_01 = new SingleModel("2016-4-12 09:46", false, "告诉姑娘，我不喜欢qq里面那个微笑的表情，是真的很讨厌很讨厌它！之前因为跟姑娘还不熟悉，而姑娘老是发这个表情，所以就也用了。但是每一次使用，都觉得很矛盾！这一刻，应该没有把姑娘仅仅是当做一个普通朋友了吧，所以不想再去用这个很讨厌的表情！", new int[]{R.mipmap.pic37});
        singleModelList0412.add(singleModel0412_01);

        SingleModel singleModel0412_02 = new SingleModel("2016-4-12 10:00", false, "哈，大言不惭的姑娘，竟然说给我寄点吃的，我的天，你丫的自己的肉都没解决呢，还想着给我买吃的~虽然这么说，但是起码姑娘说了，还是挺开心的呢！", new int[]{R.mipmap.pic38});
        singleModelList0412.add(singleModel0412_02);

        SingleModel singleModel0412_03 = new SingleModel("2016-4-12 14:57", false, "过于习惯了，所以回复姑娘的时候，直接回复了个 “1” ，哈，果然笨蛋姑娘是不懂的，而且解释半天，竟然还是不懂呢~", new int[]{R.mipmap.pic39});
        singleModelList0412.add(singleModel0412_03);

        SingleModel singleModel0412_04 = new SingleModel("2016-4-12 19:41", false, "真是不知道姑娘出于什么心理呢，我知道你是属狗的，但是也不能这样呀，直接对我叫了一声“汪~”，真的真的很美妙，以后要真的看到姑娘表演一下~ ", new int[]{R.mipmap.pic40});
        singleModelList0412.add(singleModel0412_04);

        SingleModel singleModel0412_05 = new SingleModel("2016-4-12 21:12", false, "哈，竟然答应给我孩子补习，还说从幼儿园开始，我的天， 这是把自己给卖了吗？嗯哼~！ ", new int[]{R.mipmap.pic41});
        singleModelList0412.add(singleModel0412_05);

        WholeDayModel wholeDayModel0412 = new WholeDayModel("2016-4-12", singleModelList0412, true, "2016-4-12 22:43", "D：晚安\n" +
                "\t\t L：…", R.mipmap.pic42);
        ...
        SingleModel singleModel0413_01 = new SingleModel("2016-4-13 18:20", false, "第一次说加我真好，可是，明明是我主动去加你的呀~还有，给我的备注竟然是 “吐槽区” ，说好的 髑冢 干嘛不用！？不过姑娘可以开心，真是极好的！", new int[]{R.mipmap.pic43});
        singleModelList0413.add(singleModel0413_01);

        SingleModel singleModel0413_02 = new SingleModel("2016-4-13 22:03", false, "不知道姑娘遇到什么事情了，那么晚还一个人在外面瞎转悠。一般女孩子不开心的时候都会一个人在外面走的吧，所以，能感觉得到你不开心吧。", new int[]{R.mipmap.pic44});
        singleModelList0413.add(singleModel0413_02);

        SingleModel singleModel0413_03 = new SingleModel("2016-4-13 22:49", false, "第一次对姑娘说 “乖”呢，记录一下。", new int[]{R.mipmap.pic45});
        singleModelList0413.add(singleModel0413_03);

        WholeDayModel wholeDayModel0413 = new WholeDayModel("2016-4-13", singleModelList0413, true, "2016-4-13 22:52", "D：晚安\n" +
                "\t\t L：汪~ (姑娘，你真的有胆量发一句语音，喊一声“汪”吗？)", R.mipmap.pic46);
        list.add(wholeDayModel0413);

        //2016.04.14
        List<SingleModel> singleModelList0414 = new ArrayList<>();

        WholeDayModel wholeDayModel0414 = new WholeDayModel("2016-4-14", singleModelList0414, true, "2016-4-15 01:23", "D：晚安\n" +
                "\t\t L：… (这天，是因为我陪老板在外面谈东西，太晚太晚才回去，虽然姑娘说要备课，也会弄到很晚，但是我回去的时候，应该已经睡了吧！)", R.mipmap.pic47);
        list.add(wholeDayModel0414);

        //2016.04.15
        List<SingleModel> singleModelList0415 = new ArrayList<>();

        SingleModel singleModel0415_01 = new SingleModel("2016-4-15 15:39", false, "姑娘结束公开课，看起来，效果挺好，挺开心的呢~！", new int[]{R.mipmap.pic48});
        singleModelList0415.add(singleModel0415_01);

        SingleModel singleModel0415_02 = new SingleModel("2016-4-15 18:34", false, "姑娘说无为地震了，记得很清楚，但是在下雨，我要打伞骑车，虽然那时候地震已经过了，但是还是怕出什么事情，所以手机拿在手上，姑娘一回复，就把车停下来看消息，再回复她。。。很揪心呢，虽然跟我说的时候已经没什么问题了，但是还是有些担心。虽然我没有经历过那些，但是看到了太多太多。。。。真的，幸好没事，否则我肯定不顾一切奔向无为！", new int[]{R.mipmap.pic49});
        singleModelList0415.add(singleModel0415_02);

        SingleModel singleModel0415_03 = new SingleModel("2016-4-15 20:47", false, "因为是真的有些担心姑娘，所有，即使被姑娘拒绝告诉位置，我还是在想办法找出她的位置，好在找到了，真的真的是很奇妙的事情！", new int[R.mipmap.pic50]);
        singleModelList0415.add(singleModel0415_03);

        SingleModel singleModel0415_04 = new SingleModel("2016-4-15 20:52", false, "看到姑娘连续的好几个微笑表情，即使到现在，我依然还记得当时心里那种害怕，真的会害怕姑娘会生气。其实，猜到位置真的很简单，在百度搜索关键词“无为中学”，所有无为的中学都会出来，不仅仅是姑娘所在的那个学校，之后再用距离尺量一下，所有的东西就都能看到了，唉。。。。真的会怕，太过单纯的姑娘会真的“害怕”我！", new int[]{R.mipmap.pic51});
        singleModelList0415.add(singleModel0415_04);

        WholeDayModel wholeDayModel0415 = new WholeDayModel("2016-4-15", singleModelList0415, true, "2016-4-15 23:07", "L：晚安~\n" +
                "\t\t D：晚安 (从这个时候开始，姑娘开始像我要晚安了，再之后，应该每天晚上都会要了吧)", R.mipmap.pic52);
        list.add(wholeDayModel0415);

        //2016.04.16
        List<SingleModel> singleModelList0416 = new ArrayList<>();

        SingleModel singleModel0416_01 = new SingleModel("2016-4-16 06:58", false, "哈，一大清早的，姑娘发了几张图过来，是她昨天上公开课同事拍的图，第一次愿意给图呢！可是，我猜肯定是故意的，非要选几张完全看不清脸的图，坑！", new int[]{R.mipmap.pic53});
        singleModelList0416.add(singleModel0416_01);

        SingleModel singleModel0416_02 = new SingleModel("2016-4-16 11:04", false, "哈哈哈哈，我不说话，就笑笑~", new int[]{R.mipmap.pic54});
        singleModelList0416.add(singleModel0416_02);

        SingleModel singleModel0416_03 = new SingleModel("2016-4-16 11:05", true, "说好的发工资要给姑娘买肉的呢~！", new int[]{R.mipmap.pic55});
        singleModelList0416.add(singleModel0416_03);

        SingleModel singleModel0416_04 = new SingleModel("2016-4-16 14:19", false, "聊到这里，该怎么说呢，是真的担心姑娘会一不小心，就被那倒霉的什么主任和忽悠住了，牵线给了别人！啊啊啊啊，什么主任，哪有刻意去拆散人家的！", new int[]{R.mipmap.pic56});
        singleModelList0416.add(singleModel0416_04);

        SingleModel singleModel0416_05 = new SingleModel("2016-4-16 22:30", false, "姑娘说，下辈子我们还能遇到吗？回答，你上辈子已经问过了。其实，这个世界是真的没有前世来生的，好好地把这辈子走完，已经足够了，何苦去奢求下辈子呢？！", new int[]{R.mipmap.pic57});
        singleModelList0416.add(singleModel0416_05);

        WholeDayModel wholeDayModel0416 = new WholeDayModel("2016-4-16", singleModelList0416, true, "2016-4-16 23:18", "D：晚安\n" +
                "\t\t L：晚安~  (傻姑娘，竟然以为我不说了，怎么可能，每天晚上我都会说的好吗？从来没有忘记过！)", R.mipmap.pic58);
        list.add(wholeDayModel0416);

        //2016.04.17
        List<SingleModel> singleModelList0417 = new ArrayList<>();

        SingleModel singleModel0417_01 = new SingleModel("2016-4-17 13:06", false, "哈哈，遇到一个眼里只有肉的姑娘啦，好可怕好可怕呀~", new int[]{R.mipmap.pic59});
        singleModelList0417.add(singleModel0417_01);

        SingleModel singleModel0417_02 = new SingleModel("2016-4-17 13:08", false, "这个时候，是真的很想很想给姑娘买点吃的寄过去，我都这么说了，然而后来还是被拒绝了，唉。。。。", new int[]{R.mipmap.pic60});
        singleModelList0417.add(singleModel0417_02);

        SingleModel singleModel0417_03 = new SingleModel("2016-4-17 18:22", false, "同学考研成功，过来玩，顺便请我们吃顿饭，我没有其他意思的，就是单纯得把自己吃的东西拍下来发给了姑娘。我是真的没有想过姑娘哪一天会那么惨！出去吃东西没吃多少，只能被迫买了幸运面，我自己也经常吃，所以知道吃泡面，是真的没有东西吃了， 才会那样的。最最重要的，是姑娘的那句，“所以你拍照片很讨厌”，啊，即使是现在在整理这个记录的时候看到，心里还是觉得会很难受很难受！我真的是不知道姑娘那天遭遇了什么，才能说出这样的话，之前发一些吃的图片给她的时候，不会这样的，所以，看到那句话的那一刻开始，我已经是没有一点点食欲了，即便桌上的饭菜都是我点的，还是不想吃。。。。", new int[]{R.mipmap.pic61});
        singleModelList0417.add(singleModel0417_03);

        SingleModel singleModel0417_04 = new SingleModel("2016-4-17 22:04", false, "只是回来，写了点东西，向姑娘说了声抱歉，傻傻的姑娘就被感动得一塌糊涂。。。傻姑娘，明明是我的不对啊！不仅仅是不该发吃的照片，更加让我自责的是，没有了解到你的委屈，在你委屈的时候，伤害到你，这是最不应该！", new int[]{R.mipmap.pic62});
        singleModelList0417.add(singleModel0417_04);

        SingleModel singleModel0417_05 = new SingleModel("2016-4-17 22:09", false, "哈，这个时候开始就已经证明我的重要性了吗？好像也是，从这个时候开始，往后越来越重要了吧！", new int[]{R.mipmap.pic63});
        singleModelList0417.add(singleModel0417_05);

        SingleModel singleModel0417_06 = new SingleModel("2016-4-17 22:58", false, "知道你只有一把伞，就想给你买把伞了，我都有两把伞轮着使用，像姑娘这样，一把怎么可能会够呢。。。。", new int[]{R.mipmap.pic64});
        singleModelList0417.add(singleModel0417_06);

        WholeDayModel wholeDayModel0417 = new WholeDayModel("2016-4-17", singleModelList0417, true, "2016-4-17 23:29", "L：晚安~\n" +
                "\t\t D：晚安  (原想着是让姑娘以后先说晚安的，因为我不想等待，所以我说完之后，就可以安心地把手机放下来了，只是。。。)", R.mipmap.pic65);
        list.add(wholeDayModel0417);

        //2016.04.18
        List<SingleModel> singleModelList0418 = new ArrayList<>();

        SingleModel singleModel0418_01 = new SingleModel("2016-4-18 10:48", false, "笨蛋姑娘，自信满满以为跟领导出去就能有好吃的，结果，结果，结果呢~~~", new int[]{R.mipmap.pic66});
        singleModelList0418.add(singleModel0418_01);

        SingleModel singleModel0418_02 = new SingleModel("2016-4-18 11:26", false, "'爱一个人的最高境界，就是一直守望着她，知道她的生命结束，由你自己承担起所有相思的悲伤与痛苦。'那个时候，即便是现在吧，我也只能对姑娘说，我很在乎很在乎！所以，我想我后说晚安，但是，后来想想，先说的人，是不是在期待着后面的晚安？而后说的人，说完就可以安心的放下手机，所以姑娘要她后说，确实，她后说，就不用再去等我的晚安了！", new int[]{R.mipmap.pic67});
        singleModelList0418.add(singleModel0418_02);

        SingleModel singleModel0418_03 = new SingleModel("2016-4-18 11:30", true, "答应姑娘每天晚上对她说晚安，不会忘记，也一定不会不说！！", new int[]{R.mipmap.pic68});
        singleModelList0418.add(singleModel0418_03);

        SingleModel singleModel0418_04 = new SingleModel("2016-4-18 11:35", false, "哈，竟然有耳钉，还挺漂亮呢~", new int[]{R.mipmap.pic69, R.mipmap.pic70});
        singleModelList0418.add(singleModel0418_04);

        SingleModel singleModel0418_05 = new SingleModel("2016-4-18 13:16", false, "等发工资要请姑娘吃大餐的呢~什么大餐呢~", new int[]{R.mipmap.pic71});
        singleModelList0418.add(singleModel0418_05);

        SingleModel singleModel0418_06 = new SingleModel("2016-4-18 13:44", false, "现在看到这个段子，真的真的，要比聊天的时候看到的要心疼太多太多太多！！！好像给姑娘点什么，可是什么都做不到，真的真的是很无奈很无奈！！！", new int[]{R.mipmap.pic72});
        singleModelList0418.add(singleModel0418_06);

        SingleModel singleModel0418_07 = new SingleModel("2016-4-18 13:50", false, "哈，姑娘，我终于找到证据了，看你怎么狡辩，哼哼~！！！", new int[]{R.mipmap.pic73});
        singleModelList0418.add(singleModel0418_07);

        SingleModel singleModel0418_08 = new SingleModel("2016-4-18 14:04", false, "哈哈哈，原来真正的罪证在这里，跑都跑不了咯，姑娘！", new int[]{R.mipmap.pic74, R.mipmap.pic75, R.mipmap.pic76});
        singleModelList0418.add(singleModel0418_08);

        SingleModel singleModel0418_09 = new SingleModel("2016-4-18 14:18", true, "过年的红包吗？嗯，知道了，这个其实不算承诺，但是也答应你了，所以也算承诺吧。不要问我会给你多少，我会告诉你我真的想好给你多少了吗？？", new int[]{R.mipmap.pic77});
        singleModelList0418.add(singleModel0418_09);

        SingleModel singleModel0418_10 = new SingleModel("2016-4-18 15:14", true, "要喊姑娘来杭州骑车游西湖呀~~~到哪一天才能实现，真的想快点见到姑娘！！！ ", new int[]{R.mipmap.pic78});
        singleModelList0418.add(singleModel0418_10);

        SingleModel singleModel0418_11 = new SingleModel("2016-4-18 15:50", false, "干了一件很蠢很蠢的事情吧，这件事，相比姑娘会记一辈子的，当然，我也会自责一辈子的！！为了炫耀一下吧，把以前跟同学聊天的记录拿出来，结果把自己的姓名给涂掉了，姑娘生气，很生气很生气，从认识以来，都没有这么生气过呢！真的是蠢啊！！！", new int[]{R.mipmap.pic79, R.mipmap.pic80, R.mipmap.pic81});
        singleModelList0418.add(singleModel0418_11);

        SingleModel singleModel0418_12 = new SingleModel("2016-4-18 20:04", false, "姑娘，你知道吗？你的两句“有说有笑，很对劲”是真的把我弄慌了，我知道自己错了，错得太离谱，我真的没想到把名字涂掉会让你那么生气，虽然已经过去好久好久，但是，还是想说声，抱歉！！！", new int[]{R.mipmap.pic82});
        singleModelList0418.add(singleModel0418_12);

        SingleModel singleModel0418_13 = new SingleModel("2016-4-18 22:32", true, "惹的姑娘那么生气，连晚饭都没有吃好，晚上到了阜阳领导都不给买吃的，唉。。。见到我一定要好好发泄！", new int[]{R.mipmap.pic83});
        singleModelList0418.add(singleModel0418_13);

        SingleModel singleModel0418_14 = new SingleModel("2016-4-18 23:07", false, "姑娘，下午的事真的很抱歉，我真是没想着刻意去隐瞒什么，因为真的没有必要！但是终究是做错了，终究是伤害到你，对不起！其实，你这样，我不知道是喜是忧！忧吧，就不说了，不言而喻，让你不开心就是最大的罪过！至于喜嘛，你为什么那么生气呢？！生气说明在意，在意说明在乎！", new int[]{R.mipmap.pic84});
        singleModelList0418.add(singleModel0418_14);

        SingleModel singleModel0418_15 = new SingleModel("2016-4-18 23:16", false, "我是昨天晚上才说得不要去伤害到你呀，还没到一天就伤害到了，而且更为严重！我真是不知道该怎么去说自己了，一声叹息，唉。。。。在这个时间遇到这样的一个你，而且在事情都没办法当面去解释的情况下，我是真的真的真的不希望带给你一点点的伤害，一点都不敢！你过得已经够不好了，我真的没道理再去带给你伤害，带给你不开心！", new int[]{R.mipmap.pic85});
